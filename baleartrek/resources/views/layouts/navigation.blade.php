    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('interesting_place.index')" :active="request()->routeIs('interesting_place.*')">
                ...
                <!-- Municipality  -->
                 ...
                 <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('municipalityCRUD.index')" :active="request()->routeIs('municipalityCRUD.*')">
                        {{ __('Municipalities') }}
                    </x-nav-link>
                </div>
